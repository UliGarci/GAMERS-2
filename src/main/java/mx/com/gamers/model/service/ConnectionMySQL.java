package mx.com.gamers.model.service;
...
public class ConnectionMySQL {
    public static Connection getConnection()throws SQLException {
        ...
        String port = "3306";
        String database = "gamers";
        String useSSL = "false";
        String timezone = "UTC";
        String url = String.format("jdbc:mysql://%s:%s/%s?useSSL=%s&serverTimezone", host, port, database, useSSL, timezone);
